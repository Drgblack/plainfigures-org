...
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

  {
    ...
    description: 'Given your savings and monthly burn rate, how many months can you survive without income? The maths most people have never run.',
    readTime: '6 min',
  ...
  },
  {
    ...
    description: 'A pension projection that ignores employer contributions underestimates your pot by 30â€“50%. One that ignores inflation overestimates what it buys.',
    readTime: '7 min',
  ...
  },
  {
    ...
    description: 'The 3â€“6 month rule is a wide range. The right buffer depends on income stability, dependants, and fixed obligations. Here is how to find your number.',
    readTime: '5 min',
  ...
  },
  {
    ...
    description: 'Gross, net, and cash-on-cash returns can differ by 3â€“5 percentage points on the same property. Using the wrong measure produces dangerously misleading comparisons.',
    readTime: '6 min',
    tags: ['property', 'buy to let', 'rental yield', 'investment'],
    calcHref: '/savings',
    calcLabel: 'Savings Growth Calculator',
  },
  {
    code: 'G33',
    href: '/learn/capital-gains-tax',
    title: 'Capital Gains Tax: How the Calculation Works (2025/26)',
    description: 'CGT applies when you dispose of an asset for more than you paid. The rate, exemptions, and reporting rules changed in October 2024. Here is how it works now.',
    readTime: '7 min',
  ...
  },
  {
    ...
    description: 'Withdraw too much too early and the fund depletes. Too little leaves money unspent. The 4% rule is a starting point â€” here is what it means for UK retirees.',
    readTime: '6 min',
  ...
  },
  {
    ...
    description: 'Salary sacrifice saves 28â€“42p per Â£1 depending on your tax band â€” plus your employer saves NI too. Here is how the numbers work for pensions, EVs, and cycle to work.',
    readTime: '5 min',
  ...
  },
  {
    ...
    description: 'Student loans work more like a graduate tax than a debt. Whether you repay in full, partially, or never depends on your income over the loan term.',
    readTime: '6 min',
  ...
  },
  {
    ...
    description: 'The 25% LISA bonus sounds generous. But the withdrawal penalty, Â£450k property cap, and 12-month wait mean it is not always the right choice.',
    readTime: '5 min',
  ...
  },
  {
    ...
    description: 'IHT affects fewer than 4% of estates â€” but rising house prices and frozen thresholds are changing that. Here is how the calculation, exemptions, and 7-year rule work.',
    readTime: '7 min',
  ...
  },
  {
    ...
    description: 'Banks include a spread markup in the exchange rate â€” making "no fee" transfers misleading. The real cost on a Â£10,000 transfer can reach Â£250â€“Â£400.',
    readTime: '5 min',
  ...
  },
  {
    ...
    description: 'Dividend and growth strategies can produce identical total returns. The difference is timing, tax treatment, and cashflow profile â€” here is how to compare them properly.',
    readTime: '6 min',
